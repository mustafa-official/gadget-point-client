            ...
            <ul className="xl:w-48 flex items-center justify-end">
                ...
                <li className="ml-2  relative inline-block">
                  <button className="px-[10px] py-[6px]  rounded-md border border-red-600 w-max border-neutral-300 bg-neutral-100 text-neutral-500 text-[16px] hover:-translate-y-1 transform transition duration-200 hover:shadow-md">
                    ...
                    >
                      ...
                      <FiUserPlus color="black" size={18} />
                    </Link>{" "}
                  </button>
                </li>
              )}
              ...
              <li className="ml-2 relative inline-block">
                <p className="cursor-pointer">
                  <div className="absolute cursor-pointer -top-1 right-0 z-10  flex justify-center items-center w-4 h-4 bg-black text-white text-xs font-medium  rounded-full">
                    3
                  </div>
                  <svg
              ...
              <li className="ml-2  relative inline-block">
                <p className="cursor-pointer">
                  <div className="absolute  -top-1 right-0 z-10  flex justify-center items-center w-4 h-4 bg-black text-white text-xs font-medium rounded-full">
                    8
                  </div>
                  <svg
                    className="h-9 w-9 p-2 text-red-500"
