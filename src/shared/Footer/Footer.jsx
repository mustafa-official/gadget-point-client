...
const Footer = () => {
  return (
    <footer className="bg-[#202020] md:mt-20 mt-10 tracking-wide">
      <div className="py-14 container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          <div className="lg:col-span-2">
            <Link to="/">
              <h2 className="text-xl sm:text-2xl text-white font-extrabold">
                Gadget <span className="text-red-500">Point</span>
              </h2>
            </Link>
            <p className="text-gray-300 mt-4 text-sm">
              Discover top-quality products at affordable prices. Enjoy fast
              shipping, secure payments, and exceptional customer service.
            </p>
          </div>

          <div>
            <h4 className="text-lg font-semibold mb-8 text-white">About Us</h4>
          ...
          <div>
            ...
            <div className="space-y-4">
              <p className="text-gray-300 text-sm">Mirpur 10, Dhaka</p>
              <p className="text-gray-300 text-sm">gadgetpoint@contact.com</p>
      ...
      <div className="text-center py-5 bg-[#3d3d3d]">
        <p className="text-gray-300 text-sm">
          © GadgetPoint. All rights reserved.
        </p>
      </div>
    </footer>
  );
